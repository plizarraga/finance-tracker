...
This file complements CLAUDE.md with additional guidelines for AI agents and developers.

## Project Structure & Module Organization

- `src/app/` holds Next.js App Router pages, layouts, and API route handlers.
- `src/features/` contains domain logic per feature (accounts, categories, incomes, expenses, transfers, reports, expense-templates, income-templates, transfer-templates).
...
- `Dockerfile`: Multi-stage build with dumb-init, healthcheck
- `docker-compose.yml`: Dev/test databases (PostgreSQL 18-alpine)
...
- Reference CLAUDE.md for project overview, tech stack, and key design decisions.
